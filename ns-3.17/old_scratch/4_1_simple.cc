...
int main(int argc, char *argv[])
{
  ...
  NetDeviceContainer d1 = pointToPoint.Install(nodes.Get(0), nodes.Get(4));
  ...
  NetDeviceContainer d2 = pointToPoint.Install(nodes.Get(1), nodes.Get(4));
  ...
  NetDeviceContainer d5 = pointToPoint.Install(nodes.Get(2), nodes.Get(5));
  ...
  NetDeviceContainer d6 = pointToPoint.Install(nodes.Get(3), nodes.Get(5));
  ...
  NetDeviceContainer d11 = pointToPoint.Install(nodes.Get(4), nodes.Get(6));
  address.SetBase("10.1.5.0", "255.255.255.0");
  Ipv4InterfaceContainer i11 = address.Assign(d11);
  printf(" interfaces.GetAddress(i) is %d\n\n",  i11.GetAddress(0).Get());

  NetDeviceContainer d12 = pointToPoint.Install(nodes.Get(5), nodes.Get(6));
