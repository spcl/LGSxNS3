...
int main(int argc, char *argv[])
{
  ...
  NetDeviceContainer d1 = pointToPoint.Install(nodes.Get(0), nodes.Get(6));
  ...
  NetDeviceContainer d2 = pointToPoint.Install(nodes.Get(1), nodes.Get(6));
  ...
  NetDeviceContainer d3 = pointToPoint.Install(nodes.Get(2), nodes.Get(6));
  ...
  NetDeviceContainer d5 = pointToPoint.Install(nodes.Get(3), nodes.Get(7));
  address.SetBase("10.1.4.0", "255.255.255.0");
  Ipv4InterfaceContainer i5 = address.Assign(d5);
  update_node_map(3, i5.GetAddress(0));
  nodes.Get(3)->isNic = true;
  printf(" interfaces.GetAddress(i) is %d\n\n",  i5.GetAddress(0).Get());

  NetDeviceContainer d6 = pointToPoint.Install(nodes.Get(4), nodes.Get(7));
  address.SetBase("10.1.5.0", "255.255.255.0");
  Ipv4InterfaceContainer i6 = address.Assign(d6);
  update_node_map(4, i6.GetAddress(0));
  nodes.Get(4)->isNic = true;
  printf(" interfaces.GetAddress(i) is %d\n\n",  i6.GetAddress(0).Get());

  NetDeviceContainer d7 = pointToPoint.Install(nodes.Get(5), nodes.Get(7));
  address.SetBase("10.1.6.0", "255.255.255.0");
  Ipv4InterfaceContainer i7 = address.Assign(d7);
  update_node_map(5, i7.GetAddress(0));
  nodes.Get(5)->isNic = true;
  printf(" interfaces.GetAddress(i) is %d\n\n",  i7.GetAddress(0).Get());
  
  NetDeviceContainer d11 = pointToPoint.Install(nodes.Get(6), nodes.Get(8));
  address.SetBase("10.1.7.0", "255.255.255.0");
  Ipv4InterfaceContainer i11 = address.Assign(d11);
  printf(" interfaces.GetAddress(i) is %d\n\n",  i11.GetAddress(0).Get());

  NetDeviceContainer d12 = pointToPoint.Install(nodes.Get(7), nodes.Get(8));
