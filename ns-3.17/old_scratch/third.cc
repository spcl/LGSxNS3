...
int main(int argc, char *argv[])
{
	...
	enable_qcn = true, use_dynamic_pfc_threshold = true, packet_level_ecmp = false, flow_level_ecmp = false;
	packet_payload_size = 1000, l2_chunk_size = 0, l2_ack_interval = 0;
	pause_time = 5, simulator_stop_time = 3.01, app_start_time = 1.0, app_stop_time = 9.0;
	data_rate, link_delay, topology_file, flow_file, tcp_flow_file, trace_file, trace_output_file;
	used_port[65536] = { 0 };

	cnp_interval = 50, alpha_resume_interval = 55, rp_timer, dctcp_gain = 1 / 16, np_sampling_interval = 0, pmax = 1;
	byte_counter, fast_recovery_times = 5, kmax = 60, kmin = 60;
	rate_ai, rate_hai;

	clamp_target_rate = false, clamp_target_rate_after_timer = false, send_in_chunks = true, l2_wait_for_ack = false, l2_back_to_zero = false, l2_test_read = false;
